...
var Jamendo = new function() {
    ...
    var getOne = function(entry) {
        ...
        params = {
            ...
            type: 'audio',
            artwork: 'https://i1.sndcdn.com/artworks-000036364636-0kcaux-t500x500.jpg?3eddc42',
    ...
    var searchApi = new SearchApi({
        ...
        url: function(options) {
            ...
            var url = 'http://api.jamendo.com/v3.0/tracks/?' + queryArray.concat([
                ...
                'order=buzzrate+popularity_total'
            ]).join('&');
            return url;
        }
    });
...
var SoundCloud = new function() {
    ...
    var getOne = function(entry) {
        ...
        options = {
            ...
            siteMediaID: entry.id,
            type: 'audio',
            artwork: entry.artwork_url.replace("large.jpg","t500x500.jpg"),
