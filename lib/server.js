...
var getApplication = function() {
    ...
    app.get('/', function(req, res) {
        ...
        res.render('playlist', {view: 'home', environment: additionalJS, analytics: analytics});
    });

    app.get(/^\/([1-9][0-9]*)?$/, function(req, res) {
        var additionalJS = 'js/' + env;
        res.render('playlist', {view: 'playlist', environment: additionalJS, analytics: analytics});
    });
